...
embeddings = OpenAIEmbeddings(open_api_key=api_key)
vectors = FAISS.from_documents(data, embeddings)
chain = ConversationalRetrievalChain.from_llm(llm=ChatOpenAI(temperature=0.0, model_name='gpt-3.5-turbo', open_api_key=api_key), retriever=vectors.as_retriever())
history = []
